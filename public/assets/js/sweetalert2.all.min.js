...
!(function (t, e) {
  ...
  var b = {},
    y = function (t) {
      return new Promise(function (e) {
        ...
        (b.restoreFocusTimeout = setTimeout(function () {
          b.previousActiveElement instanceof HTMLElement ? (b.previousActiveElement.focus(), (b.previousActiveElement = null)) : document.body && document.body.focus(), e();
        }, 100)),
          window.scrollTo(n, o);
      });
    },
    ...
    nt = function (e, n, o) {
      if (
        ...
        if ("string" != typeof n.customClass[o] && !n.customClass[o].forEach) return void B("Invalid type of customClass.".concat(o, '! Expected string or iterable object, got "').concat(t(n.customClass[o]), '"'));
  ...
  function xt(t, e, n) {
    var o = E(e);
    mt(t, n["show".concat(o, "Button")], "inline-block"), tt(t, n["".concat(e, "ButtonText")] || ""), t.setAttribute("aria-label", n["".concat(e, "ButtonAriaLabel")] || ""), (t.className = C[e]), nt(t, n, "".concat(e, "Button"));
  }
  var St = function (t, e) {
    var n = M();
    n &&
  ...
  var Ot = { innerParams: new WeakMap(), domCache: new WeakMap() },
    ...
    Dt = function (e, n, o) {
      if (o.inputLabel) {
        var i = document.createElement("label"),
          r = C["input-label"];
        i.setAttribute("for", e.id), (i.className = r), "object" === t(o.customClass) && at(i, o.customClass.inputLabel), (i.innerText = o.inputLabel), n.insertAdjacentElement("beforebegin", i);
      }
    },
    qt = function (t) {
    ...
    Vt = function (e, n) {
      ["string", "number"].includes(t(n)) ? (e.value = "".concat(n)) : j(n) || B('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(t(n), '"'));
    },
    Rt = {};
  (Rt.text =
    Rt.email =
  ...
  var _t = function (t, e) {
      ...
      !(function (t, e) {
        ...
        (function (t, e) {
          ...
          if (o) {
            ...
            if (e.icon || e.iconHtml) {
              if (e.icon && -1 === Object.keys(A).indexOf(e.icon)) return P('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void dt(o);
    ...
    ne = function (t, e, n) {
      t &&
        (e.isComposing || 229 === e.keyCode || (t.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? oe(e, t) : "Tab" === e.key ? ie(e) : [].concat(te, ee).includes(e.key) ? re(e.key) : "Escape" === e.key && ae(e, t, n)));
    },
    oe = function (t, e) {
  ...
  var je = function e(n) {
    ...
    He = function (t, e) {
      ...
      if (n.input) {
        ...
        n.inputValidator ? De(t, i, e) : o && !o.checkValidity() ? (t.enableButtons(), t.showValidationMessage(n.validationMessage)) : "deny" === e ? qe(t, i) : _e(t, i);
  ...
  function Je(t) {
    ...
    tt(e.validationMessage, t), (e.validationMessage.className = C["validation-message"]), n.customClass && n.customClass.validationMessage && at(e.validationMessage, n.customClass.validationMessage), lt(e.validationMessage);
    var o = this.getInput();
  ...
  function sn(t) {
    ...
    if (e && !et(e, n.hideClass.popup)) {
      var o = ln(t),
        i = Object.assign({}, n, o);
      $t(this, i), Ot.innerParams.set(this, i), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, t), writable: !1, enumerable: !0 } });
    ...
    wn = function (t) {
      t.container.onmousedown = function () {
        t.popup.onmouseup = function (e) {
          (t.popup.onmouseup = function () {}), (e.target === t.popup || (e.target instanceof HTMLElement && t.popup.contains(e.target))) && (bn = !0);
        };
      };
    },
    Cn = function (t, e, n) {
  ...
  var Tn,
    ...
    Sn = Object.freeze({
        ...
        return (
          "object" !== t(e[0]) || An(e[0])
            ? ["title", "html", "icon"].forEach(function (o, i) {
                var r = e[i];
                "string" == typeof r || An(r) ? (n[o] = r) : void 0 !== r && P("Unexpected type of ".concat(o, '! Expected "string" or "Element", got ').concat(t(r)));
              })
            : Object.assign(n, e[0]),
          n
        );
      ...
      bindClickHandler: function () {
        (Pn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this), Bn || (document.body.addEventListener("click", xn), (Bn = !0));
      },
    ...
    _n = function (t, e) {
      Array.from(t.attributes).forEach(function (n) {
        -1 === e.indexOf(n.name) &&
          B(['Unrecognized attribute "'.concat(n.name, '" on <').concat(t.tagName.toLowerCase(), ">."), "".concat(e.length ? "Allowed attributes are: ".concat(e.join(", ")) : "To set the value, use HTML within the element.")]);
      });
    },
    Nn = function (t) {
      var e = M(),
  ...
  var Zn = new WeakMap(),
        ...
        o(t, [
          {
            ...
            value: function (t) {
              ...
              if (
                ((function (t) {
                  for (var e in (!1 === t.backdrop && t.allowOutsideClick && B('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), t)) an(e), t.toast && cn(e), un(e);
                })(Object.assign({}, e, t)),
                b.currentInstance)
              ) {
    ...
    Xn = function (t, e) {
      ...
      return (o.showClass = Object.assign({}, Ge.showClass, o.showClass)), (o.hideClass = Object.assign({}, Ge.hideClass, o.hideClass)), !1 === o.animation && ((o.showClass = { backdrop: "swal2-noanimation" }), (o.hideClass = {})), o;
    },
    Gn = function (t) {
      var e = { popup: D(), container: M(), actions: Y(), confirmButton: U(), denyButton: W(), cancelButton: z(), loader: K(), closeButton: J(), validationMessage: F(), progressSteps: N() };
    ...
    eo = function (t, e) {
      return e.focusDeny && ht(t.denyButton) ? (t.denyButton.focus(), !0) : e.focusCancel && ht(t.cancelButton) ? (t.cancelButton.focus(), !0) : !(!e.focusConfirm || !ht(t.confirmButton)) && (t.confirmButton.focus(), !0);
    },
    no = function () {
